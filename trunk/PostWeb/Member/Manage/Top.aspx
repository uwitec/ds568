    ...
    <div class="head">
        <div class="overflowAuto">
            ...
            <div class="contact floatR gray">
                您好：<%=_userData.Member.UserID %> <a href="../SignOut/signout.aspx?action=out">【退出】</a> <a href="Message/MessageCenter.aspx" target="conFrame">【消息】</a> <a href="#">返回首页</a> | <a href="#">帮助中心</a>
            </div>
        </div>
    </div>
