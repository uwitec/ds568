...
<ul class="ctList">
    <li><span>电子邮箱：<label class="red">*</label></span><input type="hidden" runat="server" class="cemail" value="" id="cemail" name="cemail" /><input type="text" class="txtbox email" value="<%=_userData.Member.Email %>" id="email" name="email" maxlength="100" /></li>
