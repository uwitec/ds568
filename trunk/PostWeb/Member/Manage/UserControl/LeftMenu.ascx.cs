        ...
        get {
            ...
            { 
                case "帐号管理":
                    ...
                    rs= "<li><a href=\"Contact.aspx\">修改联系信息</a></li>"+
                ...
                case "图片管家":
                    ...
                    rs=  "<li><a  href=\"image_upload.aspx\">上传图片</a></li>" +
                            "<li><a href=\"album_list.aspx\">相册管理</a></li>" +
                            "<li><a href=\"#\">设置水印</a></li>";
                    break;
                case "公司动态":
                    ViewState["icon"] = "news";
                    rs= "<li><a  href=\"add.aspx\">发布公司动态</a></li>" +
                            "<li><a href=\"news_list.aspx\">管理公司动态</a></li>";
                    break;
                case "交易管理":
                    ViewState["icon"] = "trans";
                    rs = "<li><a  href=\"seller_order_list.aspx\">已卖出的货品</a></li>" +
                            "<li><a href=\"\">交易资料设置</a></li>"+
                            "<li><a href=\"\">物流设置</a></li>"+
                            "<li><a href=\"\">混批和发票设置</a></li>";
                    break;
            }
            return rs;
        }
