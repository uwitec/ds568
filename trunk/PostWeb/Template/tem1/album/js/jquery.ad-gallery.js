...
(function($) {
  ...
  AdGallery.prototype = {
    ...
    initBackAndForward: function() {
      ...
      $(this.scroll_back).add(this.scroll_forward).click(
        function() {
          ...
          //};
		  if(context.settings.scroll_jump > 0) {
            var top = context.settings.scroll_jump;
          };
          ...
          context.thumbs_wrapper.animate({scrollTop: top +'px'});
          return false;
        }
    ...
    highLightThumb: function(thumb) {
	  ...
	  this.thumbs_wrapper.animate({scrollTop: top +'px'});
    },
  ...
  AdGallerySlideshow.prototype = {
    ...
    create: function() {
	  ...
	  $(".ad-paly").click(function(){
		  	if(context.running){
				context.stop();
				$(this).css("background-position","-71px -1px");
				$(this).attr("title","自动播放")
			}else{
	  			context.start();
				$(this).css("background-position","-71px -46px");
    ...
    stop: function() {
	  ...
	  $(".ad-paly").css("background-position","-71px -1px");
