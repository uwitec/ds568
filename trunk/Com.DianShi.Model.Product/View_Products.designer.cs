...
namespace Com.DianShi.Model.Product
{
    ...
    partial void OnCategoryNameChanged();
		...
		[Column(Storage="_Img1", DbType="NVarChar(250)")]
		public string Img1
		{
			get
			{
		...
		[Column(Storage="_SysCatID", DbType="Int NOT NULL")]
		public int SysCatID
		{
			get
			{
		...
		[Column(Storage="_ShopCatID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ExpiredDate", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_CategoryName", DbType="NVarChar(20) NOT NULL", CanBeNull=false)]
