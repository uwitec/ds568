...
namespace Com.DianShi.Model.Member
{
    ...
    partial void DeleteDS_Members(DS_Members instance);
		...
		public DS_MembersDataContext() : 
				base("Data Source=hds-023.hichina.com;Initial Catalog=hds0230549_db;Persist Security In" +
						"fo=True;User ID=hds0230549", mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnAvaterChanged();
		...
		[Column(Storage="_Avater", DbType="NVarChar(250)", UpdateCheck=UpdateCheck.Never)]
