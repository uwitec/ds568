	...
	SetDay:function (yy,mm)   //主要的写程序**********
	{
  		...
  		for (i = 0; i < 39; i++)
		{
			...
			{ 
				...
				da.style.background = (yy == new Date().getFullYear() && month == new Date().getMonth() + 1 && day == new Date().getDate()) ? "#90b9f9" : "#e0e0e0";
...
document.writeln('<iframe id="L_DateLayer" name="L_DateLayer" frameborder="0" style="position:absolute;width:160px; height:185px;overflow:hidden; z-index:9998;display:none;"></iframe>');
