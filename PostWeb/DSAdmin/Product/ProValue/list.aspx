<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="DSAdmin_Product_ProValue_list" %>
    ...
    <table  border="0" class="tabList" align="center" cellpadding="0" cellspacing="1">
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
              ...
              <td><%#(ToolBar1.AspNetPager.CurrentPageIndex-1)*ToolBar1.AspNetPager.PageSize+Container.ItemIndex+1 %></td>
                <td>
                   <%#new Com.DianShi.BusinessRules.Product.DS_Property_Br().GetSingle((int)Eval("PropertyID")).ProName%>
                </td>
                  <td>
                   <%#Eval("PropertyValue")%>
                </td>
