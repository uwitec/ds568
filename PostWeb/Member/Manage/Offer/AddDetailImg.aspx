<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDetailImg.aspx.cs" EnableViewState="true" Inherits="Member_Manage_Offer_AddDetailImg" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/adddetailimg.js"></script>
</head>
<body>
  ...
  <ul class="headmn"><li class="tag">&nbsp;</li><li class="selmemo">选择您要插入图片的来源</li>
    ...
    <li class="menu2"><div ind="2">我的电脑</div></li>
     <li class="split">&nbsp;</li>
    <li class="menu2"><div ind="3">网上图片</div></li>
  </ul>
  <div class="ctn">
        <div class="ctnshow1">
