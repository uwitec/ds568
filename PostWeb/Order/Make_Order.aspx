...
<div class="order_wrap">
    ...
    <form id="form1">
            ...
            <div class="ads_det_item">
                ...
                <select name="province">
                    ...
                    <asp:Repeater ID="Repeater2" runat="server">
                        <ItemTemplate>
                            <option value="<%#Eval("areaname") %>,<%#Eval("id") %>" ><%#Eval("areaname").ToString().Replace("省","").Replace("市","") %></option>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        <div class="btm_wrap">
            ...
            <div class="btm_m"><textarea name="remark" dv="请输入您对该笔交易或货品的特殊要求以提醒供应商，字数不超过500字"></textarea></div>
            <div class="btm_r">
                <p>运费共计：<b>0.00</b> 元</p>
