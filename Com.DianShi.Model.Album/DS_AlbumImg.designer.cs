...
namespace Com.DianShi.Model.Album
{
    ...
    partial void OnPxChanged();
		...
		[Column(Storage="_AlbumID", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public int AlbumID
		{
			get
			{
		...
		[Column(Storage="_ImgUrl", DbType="NVarChar(50) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ImgDescript", DbType="NVarChar(500) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
